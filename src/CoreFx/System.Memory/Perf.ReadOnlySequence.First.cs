...
namespace System.Buffers.Tests
{
    public class Perf_ReadOnlySequence_First
    {
        ...
        {
            var manager = new System.Memory<byte>(new byte[bufSize], bufOffset, bufSize - 2 * bufOffset);
            var buffer = new ReadOnlySequence<byte>(manager);
        ...
        {
            var manager = new System.Memory<char>(new char[bufSize], bufOffset, bufSize - 2 * bufOffset);
            var buffer = new ReadOnlySequence<char>(manager);
