                        ...
                        )
        {
            ...
            switch (memoryMetricType)
            {
                case MemoryMetricType.AndroidMemoryConsumption:
                    parser = new AndroidMemoryParser();
                    break;
            }
            ...
            {
                // Run trace session
                using (var traceSession = TraceSessionManager.CreateSession("MemoryConsumptionSession", traceName, traceDirectory, logger, default))
                {
