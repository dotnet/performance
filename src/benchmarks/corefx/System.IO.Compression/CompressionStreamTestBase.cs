...
namespace System.IO.Compression
{
    public abstract class CompressionTestBase
    {
        ...
        {
            yield return Path.Combine("UncompressedTestFiles", "TestDocument.doc");
            yield return Path.Combine("UncompressedTestFiles", "TestDocument.docx");
            yield return Path.Combine("UncompressedTestFiles", "TestDocument.pdf");
            yield return Path.Combine("UncompressedTestFiles", "TestDocument.txt");
            yield return Path.Combine("UncompressedTestFiles", "alice29.txt");
            yield return Path.Combine("UncompressedTestFiles", "asyoulik.txt");
            yield return Path.Combine("UncompressedTestFiles", "cp.html");
            yield return Path.Combine("UncompressedTestFiles", "fields.c");
            yield return Path.Combine("UncompressedTestFiles", "grammar.lsp");
            yield return Path.Combine("UncompressedTestFiles", "kennedy.xls");
            yield return Path.Combine("UncompressedTestFiles", "lcet10.txt");
            yield return Path.Combine("UncompressedTestFiles", "plrabn12.txt");
            yield return Path.Combine("UncompressedTestFiles", "ptt5");
            yield return Path.Combine("UncompressedTestFiles", "sum");
            yield return Path.Combine("UncompressedTestFiles", "xargs.1");
        }
