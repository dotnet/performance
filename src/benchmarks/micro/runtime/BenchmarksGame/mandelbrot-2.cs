...
namespace BenchmarksGame
{
    ...
    public class Mandelbrot_2
    {
        ...
        [Benchmark(Description = nameof(Mandelbrot_2))]
        ...
        [Arguments(4000, "C7-E6-66-43-66-73-F8-A8-D3-B4-D7-97-2F-FC-A1-D3")]
        ...
        public void Bench(int width, string checksum)
        {
            int lineLen = (width - 1) / 8 + 1;
            byte[] bytes = new byte[width * lineLen];
