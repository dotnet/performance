...
''')
    ...
    precommands.execute(['/p:EnableCodeSigning=false', '/p:ApplicationId=net.dot.mauiblazortesting', '/p:ValidateXcodeVersion=false', '/p:TargetsCurrent=true', '/p:SupportedOSPlatformVersion=26.0'])
